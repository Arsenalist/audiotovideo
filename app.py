...
Get select track by permalink
Get download URL
Download audio file based on track
...
def execute():
    ...
    soundcloud_track_id = 524086464
    soundcloud_track = get_soundcloud_track(soundcloud_client_id, soundcloud_track_id)
    audio_file = download_file(soundcloud_track.download_url + "?client_id=" + soundcloud_client_id, "audio.mp3")
    image_file = download_file(soundcloud_track.artwork_url.replace('large', 't500x500'), "image.jpg")
    convert_to_video(image_file, audio_file, "video.mp4")
    execute_youtube_upload("video.mp4", soundcloud_track.title, soundcloud_track.description, 17)
